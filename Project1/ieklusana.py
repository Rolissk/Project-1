...
def whosPlaying():
    whosPlayingPath = userPath + "Project1/currentuser.json"
...
def login():
    while True:
        ...
        nameCheck = userPath + "Project1/userLog/"+userName + ".json"
    ...
    while True:
        ...
        passCheck = userPath + "Project1/userLog/" + userName+'.json'
...
def register():
    while True:
        ...
        path = userPath + "Project1/userLog/"+newName + ".json"
        if os.path.exists(path):
            ...
            if newPass == newName:
                ...
                file_path = userPath + "Project1/userLog"
...
"password": "'''+newPass+'''"
                ...
                inv_path = userPath + "Project1/userLog"
