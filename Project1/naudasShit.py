...
def cashOut():
    ...
    while True:
        ...
        balCheck = userPath + "Project1/userLog/" + userName+'.json'
        ...
        if moneyOut.isalpha():
            ...
            with open(balCheck) as money:
                ...
                pathOut = userPath + "Project1/userLog/" +str(userName)+".json"
...
def shopMenu():
    ...
    if shopIzvele == 'p':
        while True:
            from ieklusana import userName
            shop = userPath + "Project1/userLog/shopItems.json"
...
def buyingPick():
    from ieklusana import userName
    global koPirkt
    path = userPath + "Project1/userLog/" +str(userName)+"Inv.json"
...
def inventory():
    print('---------\nInventory:')
    from ieklusana import userName
    invPath = userPath + "Project1/userLog/"+str(userName)+"Inv.json"
...
def addMoney(ammount):
    from ieklusana import userName
    path = userPath + "Project1/userLog/" +str(userName)+".json"
